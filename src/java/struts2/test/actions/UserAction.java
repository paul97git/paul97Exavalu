...
public class UserAction extends ActionSupport {
    ...
    public String registerUser(){
        ...
        try {
            setCtr(getAdmin().registerUser(userName,password,firstName,lastName,email,phoneNumber));
            if (getCtr() > 0) {
    ...
    public String updateUser(){
     try {
            if (getSubmitType().equals("updatedata")) {
                ...
                int i = getDao().updateUserDetails(userName,password,firstName,lastName,email,phoneNumber);
                if (i > 0) {
